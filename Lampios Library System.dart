// PEC 02 ACTIVITY 6- OOP with dart
// LIBRARY SYSTEM
//  CLAIRE ANN LAMPIOS BSCPE -3A
...
class Library with searchIndex, mainMenuProcesses{
  ...
  List genres=["Computer Science",
		"Philosophy", 
		"Pure Science",
		"Art and Recreation",
		"History"];

  // sets number of books to 0 and number of lent books to 0 for every instance of Library
  Library(){
    allBooks=0;
    lentBooks=0;
  }

  // number of books in library's ownership including those lent out being returned
  int numOfBooks(){
    return allBooks;
  }

  // number of lent out books being returned
  int numOfLent(){
    return lentBooks;
  }
...
// test if system keeps track of books count properly
